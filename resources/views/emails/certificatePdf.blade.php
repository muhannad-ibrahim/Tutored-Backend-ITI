...
<body>
    <div class="certificate-wrapper">
        ...
        <p class="verification-number">Verification Number: <a href="{{ env('FRONT_URL') }}/main/student/certified?studentId={{ $student_id }}&courseId={{ $course_id }}&verificationNumber={{ $verification_number }}">{{ $verification_number }}</a></p>
    </div>
</body>
</html>